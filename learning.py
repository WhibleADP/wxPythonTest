...
class ExampleFrame(wx.Frame):
    def __init__(self, title='', size=(-1, -1)):
        ...
        nb.AddPage(ExamplePanel(nb), "Center Aligned")
        nb.AddPage(doodle.DoodleWindow(nb), "AWWW")
        nb.AddPage(wx.Panel(nb), "YISSS")

        self.sizer = wx.BoxSizer(wx.VERTICAL)
        self.sizer.Add((0,0), 1)
        self.sizer.Add(nb, 0, wx.ALIGN_CENTER)
        self.sizer.Add((0,0), 1)
